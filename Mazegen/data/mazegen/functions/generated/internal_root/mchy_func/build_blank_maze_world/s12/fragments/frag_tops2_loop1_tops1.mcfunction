...
data modify storage mazegen:mchy mchy_func.build_blank_maze_world.r12I.var_18.value set from storage mazegen:mchy mchy_func.step_dz_entity.r13.return.value
data modify storage mazegen:mchy mchy_func.build_blank_maze_world.r12I.var_18.is_null set from storage mazegen:mchy mchy_func.step_dz_entity.r13.return.is_null
## MCHY ##: ===== Call Complete =====
...
scoreboard players set var_xi mazegen-mchy_func-build_blank_maze_world-r012 0
