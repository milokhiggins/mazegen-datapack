...
data modify storage mazegen:mchy mchy_func.build_blank_maze_world.r17I.var_18.value set from storage mazegen:mchy mchy_func.step_dz_entity.r18.return.value
data modify storage mazegen:mchy mchy_func.build_blank_maze_world.r17I.var_18.is_null set from storage mazegen:mchy mchy_func.step_dz_entity.r18.return.is_null
## MCHY ##: ===== Call Complete =====
